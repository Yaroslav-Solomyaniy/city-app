        ...
        return (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[13.5px] leading-tight font-semibold text-foreground">{res.title}</p>
              {res.description && <p className="mt-0.5 text-[12px] leading-relaxed text-muted-foreground">{res.description}</p>}
            </div>
