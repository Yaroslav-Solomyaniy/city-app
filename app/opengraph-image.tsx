...
export default function OGImage() {
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        <img src={logoSrc} style={{ height: 68, objectFit: "contain" }} />
      </div>
      ...
      >
        ...
        <span style={{ color: "rgba(255,255,255,0.7)", fontSize: 16, fontWeight: 600, letterSpacing: "0.12em" }}>ОФІЦІЙНИЙ ПОРТАЛ ЧЕРКАС</span>
      </div>
